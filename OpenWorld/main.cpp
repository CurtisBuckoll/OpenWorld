...
int main( int argc, char** argv )
{
    ...
    ///*	Create window  */
    //_window = SDL_CreateWindow("Game", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, _winWidth, _winHeight, SDL_WINDOW_OPENGL);
    //if (_window == nullptr)
    //{
    ...
    /*	Set up OpenGL context for drawing in _window  */
